...
describe('Section', () => {
  ...
  it('applies correct CSS classes', () => {
    ...
    expect(section).toHaveClass('relative', 'scroll-mt-16', 'w-full', 'max-w-[68.75rem]', 'min-w-0', 'mx-auto', 'break-words', 'bg-surface', 'mb-3', 'shadow-lg', 'rounded-xl', 'md:mt-16', 'mt-8')
  })
  ...
  describe('Accessibility', () => {
    ...
    it('should have proper color contrast (visual test placeholder)', () => {
      ...
      // Contrast: use axe or visual review; title uses text-text-primary on bg-surface
    })
  })
})
