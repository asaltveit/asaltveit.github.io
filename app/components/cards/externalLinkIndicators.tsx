...
export const TEXT_LINK_EXTERNAL_ICON_CLASS =
  'w-4 h-4 shrink-0 opacity-0 group-hover:opacity-100 group-focus-visible:opacity-100 transition-opacity';
...
export function CardImageExternalLinkIndicator() {
  return (
    <div
      className="absolute bottom-2.5 right-2.5 z-20 pointer-events-none opacity-0 transition-opacity duration-300 group-hover:opacity-100 group-focus-visible:opacity-100"
      aria-hidden
    >
