...
export const TEXT_LINK_INTERACTIVE_CLASS =
  'rounded-sm outline-none transition-colors hover:text-accent hover:underline hover:underline-offset-4 focus-visible:text-accent focus-visible:underline focus-visible:underline-offset-4 focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2';
...
/** Accent links that stay underlined (e.g. footer). */
export const ACCENT_TEXT_LINK_UNDERLINED_CLASS = `${TEXT_LINK_INTERACTIVE_CLASS} text-accent underline underline-offset-4`;
