...
export const featuredProjects: ProjectProps[] = [
  {
    ...
    dates: "2025 - 2026",
    items: [
      "Problem: The community needed a credible, easy-to-update home for news and resources without leaning on ad-heavy platforms.",
      "Approach: Led requirements with stakeholders, iterated on layout and typography for readability, and shipped a responsive Next.js + Tailwind experience tuned for long reading sessions.",
  ...
  },
  {
    ...
    dates: "2024 - 2025",
    items: [
      "Problem: Players needed an interactive map to explore game data without drowning in raw tables.",
      "Approach: Built a modular React + Tailwind UI with Observable Plot for the map layer and Supabase for live data, emphasizing performance and predictable state as the dataset grew.",
      "Outcome: A clean, explorable map users can filter and inspect on desktop or phone, with a codebase that stayed easy to extend.",
    ],
    ...
    dates: "2024 - 2025",
    items: [
      "Problem: A researcher faced hundreds of PDFs and manual citation cleanup.",
      "Approach: Designed and implemented a Python CLI that walks folders, extracts metadata, and emits RIS for bibliography tools—prioritizing predictable output and clear error reporting.",
      "Outcome: Cut citation prep time by about 85% on the target backlog, turning weeks of work into a repeatable pipeline.",
    ],
